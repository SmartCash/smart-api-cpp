...
#ifndef SMARTCASH_API_EXCEPTION_H
#define SMARTCASH_API_EXCEPTION_H
...
class SmartcashException: public std::exception
{
private:
	int code;
	std::string msg;
...
public:
	explicit SmartcashException(int errcode, const std::string& message) {
